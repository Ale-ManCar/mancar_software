...
export default function SolutionPage({ kicker, title, description, secondary, image, imageAlt, features }: SolutionPageProps) {
  return (
    <main className="bg-gray-50">
      <section className="container mx-auto grid items-center gap-12 px-4 py-16 md:py-20 lg:grid-cols-[0.95fr_1.05fr]">
        <div>
          <p className="section-kicker">{kicker}</p>
          <h1 className="mt-5 text-4xl font-extrabold text-gray-950 md:text-6xl">{title}</h1>
