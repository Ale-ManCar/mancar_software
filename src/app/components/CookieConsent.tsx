    ...
    >
      <div className="container mx-auto flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="max-w-3xl">
          <h2 className="text-base font-extrabold text-gray-950"><Text>Uso de cookies y analítica</Text></h2>
          <p className="mt-1 text-sm leading-6 text-gray-600"><Text>
            Usamos cookies necesarias para el funcionamiento del sitio y, si aceptas, Google Analytics para entender visitas y mejorar la experiencia. Puedes revisar más detalles en la</Text>{" "}
            <Link href="/politica-de-cookies" className="font-bold text-primary-800 underline underline-offset-2 hover:text-primary-950"><Text>
              Política de cookies
            </Text></Link><Text>
            .
          </Text></p>
