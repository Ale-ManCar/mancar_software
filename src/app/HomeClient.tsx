            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="mt-6 flex justify-end">
                  <Link href={`/casos/${successCases[selectedCase].slug}`} className="text-primary-700 font-medium hover:text-primary-800" onClick={() => trackEvent('case_open_full', { slug: successCases[selectedCase].slug })}>
                    Ver caso completo →
                  </Link>
                </div>
              </div>
